...
[实习经历](intership_note.ipynb) 主要记录总结实习项目（<font color='green'>ending</font>）<br>
[其他](learning_tips.ipynb) 主要记录学习过程中环境搭建、数据下载这种类型问题（<font color='red'>pending</font>）<br>
[python四大数据结构](python_memory.ipynb) 主要记录面试官之前问过的有关python四大数据结构列表、元组、集合和字典的对比<font color='green'>done</font>）<br>
